...
I fix the design elements as n = 30 and σ = 5, I set μ = 0, and and conduct a t-test.
```{r}
...
sim_df_repeat = 
  tibble(mu = c(1:6)) %>% 
  mutate(
    output_lists = map(.x = mu, ~rerun(5000, sim_function(mu = .x))),
