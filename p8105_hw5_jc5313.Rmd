...
Next, I  use create a plot that shows the estimates and CIs of the proportion of unsolved homicides for each city. I use `geom_errorbar` to add the upper and lower limits.
```{r}
cities_tests %>%
