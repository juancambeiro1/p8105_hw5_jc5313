...
I fix the design elements as n = 30 and σ = 5, I set μ = 0, and create a list of 5000 datasets and conduct t-test.
...
Now I create a plot of the proportion of times the null was rejected and the true value of μ.
...
Now I create a plot showing the average of μ and the true value of μ. 